...
namespace EmprendeUCR.IntegrationTests.LoginContext
{
    public class LoginContextFactory<TStartup>
        ...
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            ...
            builder.ConfigureServices(services =>
            {
                var dbContextOptionsDescriptor = services.SingleOrDefault(
                    d => d.ServiceType == typeof(DbContextOptions<LoginDbContext>));
                ...
                using (var scope = sp.CreateScope())
                {
                    ...
                    var db = scopedServices.GetRequiredService<LoginDbContext>();
                    //var scdb = scopedServices.GetRequiredService<ShoppingCartDbContext2>();
                    var logger = scopedServices.GetRequiredService<ILogger<LoginContextFactory<TStartup>>>();
