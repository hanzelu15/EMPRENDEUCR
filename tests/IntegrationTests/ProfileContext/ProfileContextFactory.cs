...
namespace EmprendeUCR.IntegrationTests.ProfileContext
{
    public class ProfileContextFactory<TStartup>
        : WebApplicationFactory<TStartup> where TStartup : class
    {
        ...
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            ...
            builder.ConfigureServices(services =>
            {
                ...
                var logger = scopedServices.GetRequiredService<ILogger<ProfileContextFactory<TStartup>>>();
